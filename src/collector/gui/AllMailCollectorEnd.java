...
public class AllMailCollectorEnd extends javax.swing.JFrame {
    ...
    public AllMailCollectorEnd() {
        initComponents();
        super.setLocationRelativeTo(null);
        super.setResizable(false);
        super.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
        setTitle("JanSeva Collector End All Mail");
    ...
    public AllMailCollectorEnd(CollectorCredential collector) throws MessagingException, SQLException {
        this();
//        System.out.println(collector.getConfidentialEmail() + " " + collector.getPassword());
        this.email = collector.getConfidentialEmail();
        this.password = collector.getPassword();
        getMessageCount(email, password);
        end = totalMails;
        if (end - 9 >= 1) {
            start = end - 9;
        } else {
        ...
        recieveEmail(email, password, "new");
        draw();
...
//                         lblLogout.setForeground(Color.red);
        ...
        lblLogout.setFont(f);
                    ...
                    MailStatusDAO.createCollectorEntry(cid);
                }
    ...
    private void initComponents() {
        ...
        lblGif.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lblGif.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/ajax-loader.gif"))); // NOI18N
    ...
    private void btnForwardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnForwardActionPerformed
        ...
        clearBorder();
        visibleAll();
        recieveEmail(email, password, "back");
        try {
            draw();
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        recieveEmail(email, password, "next");
        try {
            draw();
        } catch (MessagingException ex) {
            Logger.getLogger(AllMailCollectorEnd.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnView1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnView1ActionPerformed
        try {
            MailStatusDAO.setCollectorStatus(Integer.parseInt(complaintId[0].getText().trim()), 1);
            new CollectorEndComplaintWindow(messages[0], this, new CollectorCredential(password, email));
            this.setVisible(false);
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Some Error Occured In Fetching Data\nPlease Try Again Later.", email, HEIGHT);
        }
    }//GEN-LAST:event_btnView1ActionPerformed

    private void btnView2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnView2ActionPerformed
        try {
            MailStatusDAO.setCollectorStatus(Integer.parseInt(complaintId[1].getText().trim()), 1);
            new CollectorEndComplaintWindow(messages[1], this, new CollectorCredential(password, email));
            this.setVisible(false);
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Some Error Occured In Fetching Data\nPlease Try Again Later.", email, HEIGHT);
    ...
    private void btnView3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnView3ActionPerformed
        try {
            MailStatusDAO.setCollectorStatus(Integer.parseInt(complaintId[2].getText().trim()), 1);
            new CollectorEndComplaintWindow(messages[2], this, new CollectorCredential(password, email));
            this.setVisible(false);
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Some Error Occured In Fetching Data\nPlease Try Again Later.", email, HEIGHT);
    ...
    private void btnView4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnView4ActionPerformed
        try {
            MailStatusDAO.setCollectorStatus(Integer.parseInt(complaintId[3].getText().trim()), 1);
            new CollectorEndComplaintWindow(messages[3], this, new CollectorCredential(password, email));
            this.setVisible(false);
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Some Error Occured In Fetching Data\nPlease Try Again Later.", email, HEIGHT);
    ...
    private void btnView5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnView5ActionPerformed
        try {
            MailStatusDAO.setCollectorStatus(Integer.parseInt(complaintId[4].getText().trim()), 1);
            new CollectorEndComplaintWindow(messages[4], this, new CollectorCredential(password, email));
            this.setVisible(false);
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Some Error Occured In Fetching Data\nPlease Try Again Later.", email, HEIGHT);
    ...
    private void btnView6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnView6ActionPerformed
        try {
            MailStatusDAO.setCollectorStatus(Integer.parseInt(complaintId[5].getText().trim()), 1);
            new CollectorEndComplaintWindow(messages[5], this, new CollectorCredential(password, email));
            this.setVisible(false);
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Some Error Occured In Fetching Data\nPlease Try Again Later.", email, HEIGHT);
    ...
    private void btnView7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnView7ActionPerformed
        try {
            MailStatusDAO.setCollectorStatus(Integer.parseInt(complaintId[6].getText().trim()), 1);
            new CollectorEndComplaintWindow(messages[6], this, new CollectorCredential(password, email));
            this.setVisible(false);
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Some Error Occured In Fetching Data\nPlease Try Again Later.", email, HEIGHT);
    ...
    private void btnView8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnView8ActionPerformed
        try {
            MailStatusDAO.setCollectorStatus(Integer.parseInt(complaintId[7].getText().trim()), 1);
            new CollectorEndComplaintWindow(messages[7], this, new CollectorCredential(password, email));
            this.setVisible(false);
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Some Error Occured In Fetching Data\nPlease Try Again Later.", email, HEIGHT);
    ...
    private void btnView9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnView9ActionPerformed
        try {
            MailStatusDAO.setCollectorStatus(Integer.parseInt(complaintId[8].getText().trim()), 1);
            new CollectorEndComplaintWindow(messages[8], this, new CollectorCredential(password, email));
            this.setVisible(false);
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Some Error Occured In Fetching Data\nPlease Try Again Later.", email, HEIGHT);
    ...
    private void btnView10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnView10ActionPerformed
        try {
            MailStatusDAO.setCollectorStatus(Integer.parseInt(complaintId[9].getText().trim()), 1);
            new CollectorEndComplaintWindow(messages[9], this, new CollectorCredential(password, email));
            this.setVisible(false);
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Some Error Occured In Fetching Data\nPlease Try Again Later.", email, HEIGHT);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllMailCollectorEnd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AllMailCollectorEnd().setVisible(true);
            }
        });
    }
